...
public class Calendar {
    ...
    // Method to display events or tasks
    public void displayEvents(List<VEvent> events, List<VTodo> tasks, String message) {
        // Display the provided events and tasks with their details
        System.out.println("\n*** " + message + " ***\n");
    ...
    // Method to read the iCal file
    private static String readFile(String filePath) throws IOException {
        // Read the contents of the iCal file
        byte[] encoded = Files.readAllBytes(Paths.get(filePath));
        return new String(encoded);
    }

    // Method to convert DateStart to LocalDateTime
    ...
    // Method to convert DateDue to LocalDateTime
    ...
    // Method to convert DateEnd to LocalDateTime
    static LocalDateTime convertDateEndToLocalDateTime(DateEnd dateEnd) {
        // Convert DateEnd to LocalDateTime
